...
export default function Header() {
  ...
  return (
    <header className='bg-header bg-cover h-[calc(100vh-79.62px)]'>
        <section className='backdrop-brightness-[65%] p-4 px-32 h-full'>
            <section className='container mx-auto flex gap-6 flex-col justify-center h-full'>
                ...
                <div className='flex w-4/5 rounded'>
                    <input onChange={handleChange} value={ing} placeholder='What ingredients do you have?' className=' text-black outline-none px-2 w-full border-2 border-main' type="text" />
